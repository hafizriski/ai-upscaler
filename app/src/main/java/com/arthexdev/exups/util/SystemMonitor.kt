...
data class SystemStats(
    ...
    val cpuCores: Int, val cpuFreqMhz: Int
)

object SystemMonitor {
    fun snapshot(context: Context): SystemStats {
        ...
        return SystemStats(used, total,
            Runtime.getRuntime().availableProcessors(), readFreq())
    }
